...
class TestClass(unittest.TestCase):
    ...
    def test_get_final_silence_basic_auth(self):

        method = "get"
        url = self.URL_BASE + "/final_silence"
    ...
    def test_post_final_silence_basic_auth(self):
    ...
    def test_z_delete_final_silence_basic_auth(self):
        method = "delete"
        url = self.URL_BASE + "/final_silence"
        auth = HTTPBasicAuth("usuario1", "usuario1")
        resp = requests.request(
